...
| Data Encryption certificate                  | This certificate is used by the AOS to encrypt sensitive information.  | <p>This must be created using the provider **Microsoft Enhanced RSA and AES Cryptographic Provider**. </p> <p> The key type of this CSP should be **Exchange** and not **Signature**. </p> <p> CN: DataEncryption <br> DNS Name: DataEncryption </p> |
| Data Signing certificate                     | This certificate is used by the AOS to encrypt sensitive information.  | <p> This is separate from the Data Encryption certificate and must be created using the provider **Microsoft Enhanced RSA and AES Cryptographic Provider**. </p> <p> The key type of this CSP should be **Exchange** and not **Signature**. </p> <p> CN: DataSigning <br> DNS Name: DataSigning </p> |
